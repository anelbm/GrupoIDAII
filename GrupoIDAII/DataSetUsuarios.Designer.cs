...
namespace GrupoIDAII {
    ...
    public partial class DataSetUsuarios : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuariosRow AddUsuariosRow(string nombre, string correo, string alias, string contrasenia, string departamento) {
...
namespace GrupoIDAII.DataSetUsuariosTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuarios] WHERE (([id] = @Original_id) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_correo = 1 AND [correo] IS NULL) OR ([correo] = @Original_correo)) AND ((@IsNull_alias = 1 AND [alias] IS NULL) OR ([alias] = @Original_alias)) AND ((@IsNull_contrasenia = 1 AND [contrasenia] IS NULL) OR ([contrasenia] = @Original_contrasenia)) AND ((@IsNull_departamento = 1 AND [departamento] IS NULL) OR ([departamento] = @Original_departamento)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_contrasenia", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "contrasenia", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Usuarios] ([nombre], [correo], [alias], [contrasenia], [departamento]) VALUES (@nombre, @correo, @alias, @contrasenia, @departamento);
SELECT id, nombre, correo, alias, contrasenia, departamento FROM Usuarios WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [nombre] = @nombre, [correo] = @correo, [alias] = @alias, [contrasenia] = @contrasenia, [departamento] = @departamento WHERE (([id] = @Original_id) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_correo = 1 AND [correo] IS NULL) OR ([correo] = @Original_correo)) AND ((@IsNull_alias = 1 AND [alias] IS NULL) OR ([alias] = @Original_alias)) AND ((@IsNull_contrasenia = 1 AND [contrasenia] IS NULL) OR ([contrasenia] = @Original_contrasenia)) AND ((@IsNull_departamento = 1 AND [departamento] IS NULL) OR ([departamento] = @Original_departamento)));
SELECT id, nombre, correo, alias, contrasenia, departamento FROM Usuarios WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_contrasenia", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "contrasenia", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nombre, correo, alias, contrasenia, departamento FROM dbo.Usuarios";
        ...
        public virtual int Delete(int Original_id, string Original_nombre, string Original_correo, string Original_alias, string Original_contrasenia, string Original_departamento) {
        ...
        public virtual int Insert(string nombre, string correo, string alias, string contrasenia, string departamento) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string correo, string alias, string contrasenia, string departamento, int Original_id, string Original_nombre, string Original_correo, string Original_alias, string Original_contrasenia, string Original_departamento, int id) {
            if ((nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string correo, string alias, string contrasenia, string departamento, int Original_id, string Original_nombre, string Original_correo, string Original_alias, string Original_contrasenia, string Original_departamento) {
            return this.Update(nombre, correo, alias, contrasenia, departamento, Original_id, Original_nombre, Original_correo, Original_alias, Original_contrasenia, Original_departamento, Original_id);
        }
    }
